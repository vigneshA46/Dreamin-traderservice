...
# ============================================================
def backtest_option_side(df, side="CE", daily_target=35):
    trades = []
...
def run_day_backtest(parquet_file):
    ...
    ce_trades = backtest_option_side(df, "CE",daily_target=35)
    pe_trades = backtest_option_side(df, "PE",daily_target=35)
